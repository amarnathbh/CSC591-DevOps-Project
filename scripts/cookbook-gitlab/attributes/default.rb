...
default['gitlab']['git_url'] = 'git://github.com/yatish27/gitlabhq.git'
default['gitlab']['git_branch'] = 'master'
...
default['gitlab']['shell']['git_branch'] = 'v2.6.2'
...
# Mysql
default['mysql']['server_root_password'] = 'qwerty123'
